...
void TemplateFitter::Draw()
{
  ...
  h0z->Draw("colz");
  g0->Draw("same C*");
  cchi2_0z->SaveAs(Form("%s_chi2Surface_nCov_%d%d%d_0_zoom.png",name,para,cutNu,cutEv));
  ...
  h1z->Draw("colz");
  g1->Draw("same C*");
  cchi2_1z->SaveAs(Form("%s_chi2Surface_nCov_%d%d%d_1_zoom.png",name,para,cutNu,cutEv));
  ...
  h2z->Draw("colz");
  g2->Draw("same C*");
  cchi2_2z->SaveAs(Form("%s_chi2Surface_nCov_%d%d%d_2_zoom.png",name,para,cutNu,cutEv));
  ...
  h0dz->Draw("colz");
  g0->Draw("same C*");
  cdiff_0z->SaveAs(Form("%s_chi2Diff_nCov_%d%d%d_0_zoom.png",name,para,cutNu,cutEv));
  ...
  h1dz->Draw("colz");
  g1->Draw("same C*");
  cdiff_1z->SaveAs(Form("%s_chi2Diff_nCov_%d%d%d_1_zoom.png",name,para,cutNu,cutEv));
  ...
  h2dz->Draw("colz");
  g2->Draw("same C*");
  cdiff_2z->SaveAs(Form("%s_chi2Diff_nCov_%d%d%d_2_zoom.png",name,para,cutNu,cutEv));
