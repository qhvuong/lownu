...
TemplateFitter::TemplateFitter(TH1D * CC_templates_m[400], TH1D * CC_templates_m_nc[400], TH1D * CC_templates_e[400], TH1D * nue_templates_m[400], TH1D * nue_templates_e[400], TH1D * CC_target_e, TH1D * CC_target_m, TH1D * nue_target)
{
  for( int i = 0; i < 400; ++i ) {
...
{ 
  ...
  for( int i = 10; i < 400; ++i ) {
    ...
    nue_tp_me->Add(nue_m_templates[i], Pmue);
    nue_tp_mm->Add(nue_m_templates[i], Pmm);
    nue_tp_em->Add(nue_e_templates[i], Pmue);
...
bool TemplateFitter::doFit( double &Uee2, double &Umm2, double &dm2 )
{
  ...
  fitter->SetVariable( 0, "Uee2", 0.01, 0.00001 );
  fitter->SetVariable( 1, "Umm2", 0.0016, 0.00001 );
  fitter->SetVariable( 2, "dm2", 1.3, 0.01 );
...
*/
  ...
  h_e->Draw("same");
  //tp_ee->Draw("same");
  c_e->SaveAs("CC_e_TrueDraw_1.png");
  ...
  h_m->Draw("same");
  //tp_ee->Draw("same");
  c_m->SaveAs("CC_m_TrueDraw_1.png");
