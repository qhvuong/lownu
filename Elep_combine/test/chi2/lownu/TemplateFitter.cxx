...
TemplateFitter::TemplateFitter(TH1D * templates_m[280], TH1D * templates_m_nc[280], TH1D * templates_e[280], TH1D * target)
{
  for( int i = 0; i < 280; ++i ) {
...
void TemplateFitter::Draw()
{
  ...
  h->Draw("colz");
  c->SaveAs("e_chi2Surface_223.png");
}
