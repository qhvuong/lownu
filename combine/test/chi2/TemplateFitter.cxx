...
TemplateFitter::TemplateFitter(TH1D * templates_m[400], TH1D * templates_m_nc[400], TH1D * templates_e[400], TH1D * target)
{
  for( int i = 0; i < 400; ++i ) {
...
void TemplateFitter::Draw()
{
  ...
  h->Draw("colz");
  c->SaveAs("e_chi2Surface_010.png");
}
