...
TemplateFitter::TemplateFitter(TH1D * CC_templates_m[280], TH1D * CC_templates_m_nc[280], TH1D * CC_templates_e[280], TH1D * nue_templates_m[280], TH1D * nue_templates_e[280], TH1D * CC_target_e, TH1D * CC_target_m, TH1D * nue_target)
{
  for( int i = 0; i < 280; ++i ) {
...
*/
  ...
  h_e->Draw("same");
  //tp_ee->Draw("same");
  c_e->SaveAs("CC_e_TrueDraw_31.png");
  ...
  h_m->Draw("same");
  //tp_ee->Draw("same");
  c_m->SaveAs("CC_m_TrueDraw_31.png");
