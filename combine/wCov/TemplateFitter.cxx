...
{ 
  ...
  //TMatrixD covmtr(3*nbins_Elep, 3*nbins_Elep);
  TMatrixD unc(3*nbins_Elep, 3*nbins_Elep);
  TMatrixD covmtr_tot(3*nbins_Elep, 3*nbins_Elep);
  //TMatrixD inv_covmtr_tot(3*nbins_Elep, 3*nbins_Elep);
  ...
  for( int bx = 0; bx < nbins_Elep; bx++ ) {
    ...
    //std::cout << CC_m_target->GetNbinsX() << "\t" << CC_e_target->GetNbinsX() << "\t" << nue_em_target->GetNbinsX() << "\n";
  ...
  for( int bx = 0; bx < 3*nbins_Elep; bx++ ) {
    ...
    //chi2_new += diff_T * inv_covmtr_tot * diff;
  }

  //std::cout << chi2 << "\t" << chi2_new << "\n";
  ...
  h_e->Draw("same");
  //tp_ee->Draw("same");
  c_e->SaveAs("CC_e_fit_200_ft.png");
  ...
  h_m->Draw("same");
  //tp_ee->Draw("same");
  c_m->SaveAs("CC_m_fit_200_ft.png");
  ...
  h->Draw("same");
  //tp_ee->Draw("same");
  c->SaveAs("nue_fit_200_ft_Log.png");
...
/*
  ...
  std::cout << CC_e_target->GetNbinsX() << "\t" << CC_m_target->GetNbinsX() << "\t" << nue_em_target->GetNbinsX() << "\n";
  ...
  h_e->Draw("same");
  //tp_ee->Draw("same");
  c_e->SaveAs("CC_e_fit_232_ft.png");
  ...
  CC_tp_m->SetLineColor(2);
  CC_tp_m->Draw("same");
  c_e->SaveAs("CC_e_fit_202_ft.png");
  ...
  h_m->Draw("same");
  //tp_ee->Draw("same");
  c_m->SaveAs("CC_m_fit_232_ft.png");
  ...
  h->Draw("same");
  //tp_ee->Draw("same");
  c->SaveAs("nue_fit_232_ft_Log.png");
*/
...
void TemplateFitter::TrueDraw()
{
  ...
  h_e->Draw("same");
  //tp_ee->Draw("same");
  c_e->SaveAs("CC_e_TrueDraw_23_ft.png");
  ...
  h_m->Draw("same");
  //tp_ee->Draw("same");
  c_m->SaveAs("CC_m_TrueDraw_23_ft.png");
  ...
  h->Draw("same");
  //tp_ee->Draw("same");
  c->SaveAs("nue_TrueDraw_23_ft_Log.png");
