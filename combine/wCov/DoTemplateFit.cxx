...
int main()
{
  TFile *CC_f = new TFile("/nashome/q/qvuong/gen_data/CC/output_2.root","READ");
  TFile *nue_f = new TFile("/nashome/q/qvuong/gen_data/nuescattering/nue_output_2.root","READ");
  Int_t cutNo = 0;
  ...
  TH1D * nue_target_ft = (TH1D*)nue_f->Get(Form("hElep_w%d_ft",cutNo));


  TFile *cov_f = new TFile("/nashome/q/qvuong/cov_matrix/cov.root","READ");
