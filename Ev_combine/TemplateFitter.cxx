...
void TemplateFitter::Draw()
{
  ...
  legend_e->Draw();
  c_e->SaveAs(Form("%s_fit_CC_e_%d%d%d_%d_ft.png",name,para,cutNu,cutEv,s));
  ...
  legend_m->Draw();
  c_m->SaveAs(Form("%s_fit_CC_m_%d%d%d_%d_ft.png",name,para,cutNu,cutEv,s));
  ...
  legend_nue->Draw();
  c->SaveAs(Form("%s_fit_nue_%d%d%d_%d_ft_Log.png",name,para,cutNu,cutEv,s));

  TFile *f = new TFile(Form("/dune/app/users/qvuong/lownu/Ev_combine/chi2/%s_chi2_nCov_%d%d%d.root",name,para,cutNu,cutEv));
  TH2D *hc0 = (TH2D*)f->Get("h0;1");
  TH2D *hc1 = (TH2D*)f->Get("h1;1");
  TH2D *hc2 = (TH2D*)f->Get("h2;1");
  TH2D *hc0d = (TH2D*)f->Get("h0d;1");
  TH2D *hc1d = (TH2D*)f->Get("h1d;1");
  TH2D *hc2d = (TH2D*)f->Get("h2d;1");
  ...
  legend0->Draw();
  c0->SaveAs(Form("%s_fit_parDraw_%d%d%d_%d0.png",name,para,cutNu,cutEv,s));
  ...
  legend1->Draw();
  c1->SaveAs(Form("%s_fit_parDraw_%d%d%d_%d1.png",name,para,cutNu,cutEv,s));
  ...
  legend2->Draw();
  c2->SaveAs(Form("%s_fit_parDraw_%d%d%d_%d2.png",name,para,cutNu,cutEv,s));
  ...
  legend0L->Draw();
  c0L->SaveAs(Form("%s_fit_parDraw_diff_%d%d%d_%d0_Log.png",name,para,cutNu,cutEv,s));
  ...
  legend1L->Draw();
  c1L->SaveAs(Form("%s_fit_parDraw_diff_%d%d%d_%d1_Log.png",name,para,cutNu,cutEv,s));
  ...
  legend2L->Draw();
  c2L->SaveAs(Form("%s_fit_parDraw_diff_%d%d%d_%d2_Log.png",name,para,cutNu,cutEv,s));
