...
class TemplateFitter {
  ...
  public:
    ...
    TemplateFitter(TH1D * CC_templates_m[400], TH1D * CC_templates_m_nc[400], TH1D * CC_templates_e[400], TH1D * nue_templates_m[400], TH1D * nue_templates_e[400], TH1D * CC_target_m, TH1D * CC_target_e, TH1D * nue_target);
    ~TemplateFitter(){};
