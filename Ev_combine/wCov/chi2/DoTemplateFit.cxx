...
int main()
{
  ...
  TH1D * nue_target_ft  = (TH1D*)nue_f->Get(Form("h%s%d_ft",var,EvCut));

  TFile *cov_f = new TFile(Form("/dune/app/users/qvuong/lownu/cov_matrix/%s_covmtr%d%d%d_10000.root",var,oscpar,nuCut,EvCut),"READ");
