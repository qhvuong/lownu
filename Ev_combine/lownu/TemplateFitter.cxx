...
void TemplateFitter::Draw()
{
  ...
  gPad->SetLogy();
  CC_e_target->GetXaxis()->SetRangeUser(0,20);
  CC_e_target->Draw();
  CC_tp_e->Draw("same");
  CC_tp_me->Draw("same");
  CC_tp_ee->Draw("same");
  ...
  TFile *f = new TFile(Form("/dune/app/users/qvuong/lownu_analysis/Ev_combine/chi2/lownu/Ev_chi2_%d%d_%d.root",para,cutNo,cutEv));
