...
*/   
  ...
  cTarget->cd(4);
  m_hElep_w3_ft->Draw();
  cTarget->SaveAs("true_CC_target_ft_2.pdf");
  ...
  e_cElep_w->cd(2);
  e_hsElep_w3->Draw();
  e_cElep_w->SaveAs("true_CC_e_Elep_reco_w_2.pdf");
  ...
  m_cElep_w->cd(2);
  m_hsElep_w3->Draw();
  m_cElep_w->SaveAs("true_CC_m_Elep_reco_w_2.pdf");
  ...
  cElepVsEv->SaveAs("true_CC_ElepVsEv_2.pdf");
/*
