...
*/
  ...
  cElep_w->cd(4);
  m_hsElep_w3->Draw();
  cElep_w->SaveAs("true_CC_Elep_reco_w_4.pdf");
  ...
  cElepVsEv->SaveAs("true_CC_ElepVsEv_4.pdf");

  TFile *out = new TFile("/nashome/q/qvuong/gen_data/CC_output_4.root","RECREATE");
  e_hElep_w0->Write();
  e_hElep_w3->Write();
  me_hElep_w0->Write();
  me_hElep_w3->Write();
