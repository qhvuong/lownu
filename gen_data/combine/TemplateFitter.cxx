...
#include "TCanvas.h"
#include "THStack.h"
TemplateFitter::TemplateFitter(TH1D *CC_templates_m[400], TH1D *CC_templates_m_nc[400], TH1D *CC_templates_e[400], TH1D *nue_templates_m[400], TH1D *nue_templates_e[400], TH1D *target_m, TH1D *target_e)
{
  for( int i = 0; i < 400; ++i ) {
...
{ 
  ...
  tp_me->Reset();
  TH1D *tp_me_nc = (TH1D*) nc_m_templates[0]->Clone();
  tp_me_nc->Reset();
...
bool TemplateFitter::doFit( double &Uee2, double &Umm2, double &dm2 )
{
  ...
  fitter->SetVariable( 0, "Uee2", 0.0, 0.00001 );
  fitter->SetVariable( 1, "Umm2", 0.0, 0.00001 );
  fitter->SetVariable( 2, "dm2", 0.1, 0.01 );
