...
void nuescattering()
{
  ...
  for( int ii = 0; ii < N; ++ii )
  {
    ...
    if(pdg[1] == 14){
      ...
      //muon to electron
      me_hElep_w0->Fill(E[0],pmue);
      me_hElep_w3->Fill(E[0],pmue);
    ...
    if(pdg[1] == 12){
      ...
      //electron to muon 
      em_hElep_w0->Fill(E[0],pmue);
      em_hElep_w3->Fill(E[0],pmue);
  ...
  //hElep_w0_test->Add(os_hElep_w0); hElep_w0_test->Add(unos_hElep_w0);  
  ...
  THStack *e_hsElep_w3 = new THStack("e_hsElep_w3","oscillated + unoscillated nue weighted Elep_reco (zoom)");
  ...
  THStack *m_hsElep_w3 = new THStack("m_hsElep_w3","oscillated + unoscillated numu weighted Elep_reco (zoom)");
  ...
  cElep_w->cd(4);
  m_hsElep_w3->Draw();
  cElep_w->SaveAs("true_nue_Elep_reco_w_4.pdf");
...
/*
  ...
  mm_hElep_w0->GetXaxis()->SetTitle("Elep_reco");
  m_hsElep_w0->Add(mm_hElep_w0);
  TCanvas *cElep_w0 = new TCanvas("cElep_w0","",1600,600);
  cElep_w0->Divide(2,1);
  cElep_w0->cd(1);
  hsElep_w0->Draw();
  cElep_w0->cd(2);
  hElep_w0->SetTitle("oscillated + unoscillated weighted Elep_reco");
  hElep_w0->GetXaxis()->SetTitle("Elep_reco");
  hElep_w0->Draw();
  cElep_w0->SaveAs("nue_Elep_reco_w_2_sum.pdf");*/
  ...
  cElepVsEv->SaveAs("true_nue_ElepVsEv_4.pdf");

  TFile *out = new TFile("nue_output_4.root","RECREATE");
  e_hElep_w0->Write();
  e_hElep_w3->Write();
  me_hElep_w0->Write();
  me_hElep_w3->Write();
