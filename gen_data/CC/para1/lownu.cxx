...
int main()
{
  ...
  cElep_Target->cd(4);
  m_hElep_w3_ft->Draw();
  cElep_Target->SaveAs("true_CC_ElepReco_target_ft_1.png");
  ...
  cEv_Target->SaveAs("true_CC_EvReco_target_ft_1.png");
  ...
  e_cElep_w->cd(2);
  e_hsElep_w3->Draw();
  e_cElep_w->SaveAs("true_CC_e_Elep_reco_w_1.png");
  ...
  e_cEv_w->cd(2);
  e_hsEv_w3->Draw();
  e_cEv_w->SaveAs("true_CC_e_Ev_reco_w_1.png");
  ...
  m_cElep_w->cd(2);
  m_hsElep_w3->Draw();
  m_cElep_w->SaveAs("true_CC_m_Elep_reco_w_1.png");
  ...
  m_cEv_w->cd(2);
  m_hsEv_w3->Draw();
  m_cEv_w->SaveAs("true_CC_m_Ev_reco_w_1.png");
  ...
  cElepVsEv->SaveAs("true_CC_ElepVsEv_1.png");
  ...
  cEvVsEv->SaveAs("true_CC_EvRecoVsEv_1.png");
  ...
  cElepVsEv_cov->SaveAs("cov_CC_ElepVsEv_1.png");
  ...
  cEvVsEv_cov->SaveAs("cov_CC_EvRecoVsEv_1.png");
/*
...
*/
  TFile *out = new TFile("/nashome/q/qvuong/gen_data/CC/output_1.root","RECREATE");
  e_hElep_w0->Write();
  e_hElep_w3->Write();
  e_hElep_w0_ft->Write();
  e_hElep_w3_ft->Write();
