...
int main()
{
  ...
  lm3->Draw();
  cElep_Target->SaveAs("true_CC_Elep_target_2.png");
  ...
  lmEv3->Draw();
  cEv_Target->SaveAs("true_CC_Ev_target_2.png");
  ...
  lmEv31->Draw();
  cEv_Target1->SaveAs("true_CC_Ev_target_2_Log.png");
  ...
  cElepVsEv->SaveAs("true_CC_Elep_templates_2.png");
  ...
  cEvVsEv->SaveAs("true_CC_Ev_templates_2.png");
  ...
  cElepVsEv_cov->SaveAs("cov_CC_Elep_2.png");
  ...
  cEvVsEv_cov->SaveAs("cov_CC_Ev_2.png");

  TFile *out = new TFile("/dune/app/users/qvuong/lownu/gen_data/CC/output_2.root","RECREATE");
  e_hElep_w0->Write();
  e_hElep_w3->Write();
  e_hElep_w0_ft->Write();
  e_hElep_w3_ft->Write();
