...
int main()
{
  ...
  TH1D *mm_hEvReco_w0 = new TH1D("mm_hEvReco_w0","",100,0,120);
  TH1D *mm_hEvReco_w3 = new TH1D("mm_hEvReco_w3","",100,0,120);
  TH1D *ee_hEvReco_w0 = new TH1D("ee_hEvReco_w0","",100,0,120);
  TH1D *ee_hEvReco_w3 = new TH1D("ee_hEvReco_w3","",100,0,120);
  TH1D *me_hEvReco_w0 = new TH1D("me_hEvReco_w0","",100,0,120);
  TH1D *me_hEvReco_w3 = new TH1D("me_hEvReco_w3","",100,0,120);
  TH1D *em_hEvReco_w0 = new TH1D("em_hEvReco_w0","",100,0,120);
  TH1D *em_hEvReco_w3 = new TH1D("em_hEvReco_w3","",100,0,120);
  TH1D *e_hEvReco_w0 = new TH1D("e_hEvReco_w0","",100,0,120);
  TH1D *e_hEvReco_w3 = new TH1D("e_hEvReco_w3","",100,0,120);
  TH1D *m_hEvReco_w0 = new TH1D("m_hEvReco_w0","",100,0,120);
  TH1D *m_hEvReco_w3 = new TH1D("m_hEvReco_w3","",100,0,120);
  TH1D *e_hEvReco_w0_ft = new TH1D("e_hEvReco_w0_ft","",100,0,120);
  TH1D *e_hEvReco_w3_ft = new TH1D("e_hEvReco_w3_ft","",100,0,120);
  TH1D *m_hEvReco_w0_ft = new TH1D("m_hEvReco_w0_ft","",100,0,120);
  TH1D *m_hEvReco_w3_ft = new TH1D("m_hEvReco_w3_ft","",100,0,120);
  ...
  TH2D *m_hEvRecoVsEv0 = new TH2D("m_hEvRecoVsEv0","",nbinsX,xEdges,100,0,120);
  TH2D *m_hEvRecoVsEv3 = new TH2D("m_hEvRecoVsEv3","",nbinsX,xEdges,100,0,120);
  TH2D *nc_m_hEvRecoVsEv0 = new TH2D("nc_m_hEvRecoVsEv0","",nbinsX,xEdges,100,0,120);
  TH2D *nc_m_hEvRecoVsEv3 = new TH2D("nc_m_hEvRecoVsEv3","",nbinsX,xEdges,100,0,120);
  TH2D *e_hEvRecoVsEv0 = new TH2D("e_hEvRecoVsEv0","",nbinsX,xEdges,100,0,120);
  TH2D *e_hEvRecoVsEv3 = new TH2D("e_hEvRecoVsEv3","",nbinsX,xEdges,100,0,120);

  TH2D *m_hEvRecoVsEv0_cov = new TH2D("m_hEvRecoVsEv0_cov","",19,mubins,100,0,120);
  TH2D *m_hEvRecoVsEv3_cov = new TH2D("m_hEvRecoVsEv3_cov","",19,mubins,100,0,120);
  TH2D *e_hEvRecoVsEv0_cov = new TH2D("e_hEvRecoVsEv0_cov","",7,ebins,100,0,120);
  TH2D *e_hEvRecoVsEv3_cov = new TH2D("e_hEvRecoVsEv3_cov","",7,ebins,100,0,120);
  ...
  for( int ii = 0; ii < N; ++ii )
  {
    ...
    if(LepPDG == 13){
      ...
      if(nu<10.0) { me_hElep_w0->Fill(LepE_sm,pmue); me_hEvReco_w0->Fill(Ev_reco,pmue); }
      if(nu<0.3)  { me_hElep_w3->Fill(LepE_sm,pmue); me_hEvReco_w3->Fill(Ev_reco,pmue); }
        
      //templates: muon without cuts
      if(nu<10.0) { nc_m_hElepVsEv0->Fill(Ev,LepE_sm); nc_m_hEvRecoVsEv0->Fill(Ev,Ev_reco); }   
      if(nu<0.3)  { nc_m_hElepVsEv3->Fill(Ev,LepE_sm); nc_m_hEvRecoVsEv3->Fill(Ev,Ev_reco); }
    
      if( reco_numu && (muon_contained || muon_tracker || muon_ecal))
      {
        //target: muon to muon ("survival")
        if(nu<10.0) { mm_hElep_w0->Fill(LepE_sm,pmumu); mm_hEvReco_w0->Fill(Ev_reco,pmumu); }   
        if(nu<0.3)  { mm_hElep_w3->Fill(LepE_sm,pmumu); mm_hEvReco_w3->Fill(Ev_reco,pmumu); }
      
        //templates: muon with cuts
        if(nu<10.0) { m_hElepVsEv0->Fill(Ev,LepE_sm); m_hElepVsEv0_cov->Fill(Ev,LepE_sm);
		      m_hEvRecoVsEv0->Fill(Ev,Ev_reco); m_hEvRecoVsEv0_cov->Fill(Ev,Ev_reco); }    
        if(nu<0.3)  { m_hElepVsEv3->Fill(Ev,LepE_sm); m_hElepVsEv3_cov->Fill(Ev,LepE_sm); 
		      m_hEvRecoVsEv3->Fill(Ev,Ev_reco); m_hEvRecoVsEv3_cov->Fill(Ev,Ev_reco); }
      }  
    }
    ...
    if(LepPDG == 11){
      ...
      if(nu<10.0) { ee_hElep_w0->Fill(LepE_sm,pee); ee_hEvReco_w0->Fill(Ev_reco,pee); }
      if(nu<0.3)  { ee_hElep_w3->Fill(LepE_sm,pee); ee_hEvReco_w3->Fill(Ev_reco,pee); }
      
      //target: electron to muon 
      if(nu<10.0) { em_hElep_w0->Fill(LepE_sm,pmue); em_hEvReco_w0->Fill(Ev_reco,pmue); }
      if(nu<0.3)  { em_hElep_w3->Fill(LepE_sm,pmue); em_hEvReco_w3->Fill(Ev_reco,pmue); }
      
      //templates: eletron
      if(nu<10.0) { e_hElepVsEv0->Fill(Ev,LepE_sm); e_hElepVsEv0_cov->Fill(Ev,LepE_sm); 
		    e_hEvRecoVsEv0->Fill(Ev,Ev_reco); e_hEvRecoVsEv0_cov->Fill(Ev,Ev_reco); }
      if(nu<0.3)  { e_hElepVsEv3->Fill(Ev,LepE_sm); e_hElepVsEv3_cov->Fill(Ev,LepE_sm); 
		    e_hEvRecoVsEv3->Fill(Ev,Ev_reco); e_hEvRecoVsEv3_cov->Fill(Ev,Ev_reco); }
      }
      }
    }
  }
  ...
  TCanvas *cElep_Target = new TCanvas("cElep_Target","",1600,1200);
  ...
  cElep_Target->cd(4);
  m_hElep_w3_ft->Draw();
  cElep_Target->SaveAs("true_CC_ElepReco_target_ft_2.png");
  ...
  TCanvas *cEv_Target = new TCanvas("cEv_Target","",1600,1200);
  ...
  cEv_Target->SaveAs("true_CC_EvReco_target_ft_2.png");
  ...
  e_cElep_w->cd(2);
  e_hsElep_w3->Draw();
  e_cElep_w->SaveAs("true_CC_e_Elep_reco_w_2.png");
  ...
  me_hEvReco_w3->SetMarkerColor(kRed);
  e_hsEv_w3->Add(me_hEvReco_w3);
  ee_hEvReco_w3->SetMarkerStyle(21);
  ee_hEvReco_w3->SetMarkerSize(0.5);
  ee_hEvReco_w3->SetMarkerColor(kBlue);
  e_hsEv_w3->Add(ee_hEvReco_w3);
  TCanvas *e_cEv_w = new TCanvas("e_cEv_w","",1600,600);
  e_cEv_w->Divide(2,1);
  e_cEv_w->cd(1);
  e_hsEv_w0->Draw();
  e_cEv_w->cd(2);
  e_hsEv_w3->Draw();
  e_cEv_w->SaveAs("true_CC_e_Ev_reco_w_2.png");
  ...
  m_cElep_w->cd(2);
  m_hsElep_w3->Draw();
  m_cElep_w->SaveAs("true_CC_m_Elep_reco_w_2.png");
  ...
  em_hEvReco_w3->SetMarkerColor(kRed);
  m_hsEv_w3->Add(em_hEvReco_w3);
  mm_hEvReco_w3->SetMarkerStyle(21);
  mm_hEvReco_w3->SetMarkerSize(0.5);
  mm_hEvReco_w3->SetMarkerColor(kBlue);
  m_hsEv_w3->Add(mm_hEvReco_w3);
  TCanvas *m_cEv_w = new TCanvas("m_cEv_w","",1600,600);
  m_cEv_w->Divide(2,1);
  m_cEv_w->cd(1);
  m_hsEv_w0->Draw();
  m_cEv_w->cd(2);
  m_hsEv_w3->Draw();
  m_cEv_w->SaveAs("true_CC_m_Ev_reco_w_2.png");
  ...
  cElepVsEv->SaveAs("true_CC_ElepVsEv_2.png");
  ...
  TCanvas *cEvVsEv = new TCanvas("cEvVsEv","",1200,600);
  cEvVsEv->Divide(3,2);
  cEvVsEv->cd(1);
  ...
  cEvVsEv->SaveAs("true_CC_EvRecoVsEv_2.png");
  ...
  TCanvas *cElepVsEv_cov = new TCanvas("cElepVsEv_cov","",800,600);
  ...
  cElepVsEv_cov->SaveAs("cov_CC_ElepVsEv_2.png");
  ...
  TCanvas *cEvVsEv_cov = new TCanvas("cEvVsEv_cov","",800,600);
  ...
  cEvVsEv_cov->SaveAs("cov_CC_EvRecoVsEv_2.png");
/*
...
*/
  TFile *out = new TFile("/dune/app/users/qvuong/lownu_analysis/gen_data/CC/output_2.root","RECREATE");
  e_hElep_w0->Write();
  e_hElep_w3->Write();
  e_hElep_w0_ft->Write();
  e_hElep_w3_ft->Write();
