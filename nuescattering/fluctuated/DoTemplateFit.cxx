...
int main()
{
  TFile *f = new TFile("/nashome/q/qvuong/gen_data/nuescattering/nue_output_1.root","READ");
  Int_t cutNo = 0;
  ...
  TemplateFitter tf( templates_m, templates_m_w, templates_e, templates_e_w, target_ft );
