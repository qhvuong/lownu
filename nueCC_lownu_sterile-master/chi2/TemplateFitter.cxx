...
void TemplateFitter::Draw()
{
  ...
  double levels[] = {1E-10, 10.00, 100, 500, 1000, 1E4, 1E5, 3.4e38};
  //levels[0] = 1E-10;
/*
  for(int i = 0; i < nLevels; i++){
    levels[i] = min + i*(max-min)/nLevels;
  }
  //double levels[10] = 
*/
  ...
  //h->DrawClone("colz text");
  //h->SetContour((sizeof(levels)/sizeof(double)), levels);
  h->GetZaxis()->SetRangeUser(1.0, 1E5);
  h->Draw("colz");
  c->SaveAs("test.png");
  //c->SaveAs("true_CC_e_chi2Surface_200_ft.png");
}
